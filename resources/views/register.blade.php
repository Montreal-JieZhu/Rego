...
<html>
    ...
    <body>
        ...
        <div id="contact">
            <div class="container">
                <div class="intro">
                    <h2>Bienvenue à Rego!</h2>
                    <p>Vous aurez la meilleure expérience ici!</p>
                </div>
                <form action="/userdb" method="post" id="Register-form" onsubmit=" return validationFunction(this)">
                    <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                    <div class="messages"></div>
                    <div class="controls">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group"><label class="control-label" for="firstname">Prénom* </label><input class="form-control" required type="text" name="firstname" required="" placeholder="John" id="firstname" data-error="Vorname erforderlich.">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"><label class="control-label"  for="lastname">Nom* </label><input class="form-control" required type="text" name="lastname" required="" placeholder="Smith" id="lastname" data-error="Nachname erforderlich.">
                                    <div
                                        class="help-block with-errors"></div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group"><label class="control-label" for="phone">Téléphone portable </label><input class="form-control" required type="number" name="phone" placeholder="5141231234" id="phone" data-error="Telefonnummer erforderlich">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group"><label class="control-label" for="password">Mot de passe* </label><input class="form-control" required type="password" name="password" required="" placeholder="" id="password" data-error="Nachricht erforderlich."
                                                                                                                             rows="4">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group"><label class="control-label" for="confirm">Confirmer* </label><input class="form-control" required type="password" name="confirm" required="" placeholder="" id="confirm" data-error="Nachricht erforderlich."
                                                                                                                         rows="4">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <button class="btn btn-success btn-send" onclick="window.history.back();" >Arrière</button>
                            <button class="btn btn-success btn-send" type="submit" value="submit">Soumettre
                            </button>
                        </div>
                    </div>
                    <!--
