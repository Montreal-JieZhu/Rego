    ...
    <body>           
        ...
        <nav class="site-header sticky-top py-1">
            <div class="container d-flex flex-column flex-md-row justify-content-between">
                ...
                <?php else: ?>
                    ...
                    <a id='logstatus' class="py-2 d-none d-md-inline-block" href="/logout">Hi {{($_SESSION['userID'])->first_name}} Logout</a>
                <?php endif; ?>
        ...
        <nav class="site-header sticky-top py-1">
            <div class="container d-flex flex-column flex-md-row justify-content-between">
                ...
                -->                  
                <?php if (empty($_SESSION['userID'])): ?>
                    <a id='logstatus' class="py-2 d-none d-md-inline-block" href="/login">S'identifier</a>
                <?php else: ?>
                    <!--<a id='logstatus' class="py-2 d-none d-md-inline-block" onclick='this.innerHTML = "Login";setTimeout(changeHref, 1000);' href='#'>Logout</a>-->
                    <a id='logstatus' class="py-2 d-none d-md-inline-block" href="/logout">Hi {{($_SESSION['userID'])->first_name}} Connectez - Out</a>
                <?php endif; ?>
                <a class="py-2 d-none d-md-inline-block" href="/register">registre</a>
            </div>
        </nav>
        @endif
        @show
